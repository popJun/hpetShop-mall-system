...
<div class="w" id="logo">
    <div>
        <a href="http://www.hpetshop.com">
            <img src="http://192.168.138.128/images/1526793978386209.jpg" alt="Hp商城" width="170" height="60"/>
        </a> <b></b>
    </div>
</div>
            ...
            <div class="form" onselectstart="return false;">
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《Hp用户注册协议》</a></label>
                        <span class="clr"></span>
                ...
                $.ajax({
                           ...
                           success: function (data) {
                               if (data.data) {
                                   //检查手机号是否存在
                                   $.ajax({
                                              //由于get请求会被浏览器缓存所有要加上random防止浏览器缓存
