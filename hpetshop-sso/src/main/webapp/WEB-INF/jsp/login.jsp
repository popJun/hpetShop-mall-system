...
<div class="w">
    <div id="logo">
        <a href="http://www.hpetshop.com" clstag="passport|keycount|login|01">
            <img src="http://192.168.138.128/images/1526793978386209.jpg" alt="Hp" width="170" height="60"/>
        </a><b></b>
    </div>
</div>
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02"
                 style="width: 511px; height: 455px; position: absolute; left: -44px; top: -44px; background: url() 0px 0px no-repeat;">
            </div>
            <div class="form ">
        ...
        doLogin: function () {
            $.post("/user/login", $("#formlogin").serialize(), function (data) {
                if (data.status == 200) {
                    alert("登录成功！");
                    if (redirectUrl == "") {
                        location.href = "http://www.hpetshop.com";
                    } else {
